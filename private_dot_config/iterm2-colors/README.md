...
El sistema cambia automáticamente el color de las pestañas de iTerm2 basándose en el **directorio actual**. Cuando cambias de directorio con `cd`, el color de la pestaña se actualiza automáticamente.
